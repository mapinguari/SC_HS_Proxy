...
supplyRequired :: UnitType -> Int
canAttack :: UnitType -> Bool --Wrong
maxShields :: UnitType -> Int
isBuilding :: UnitType -> Bool
isSpellCaster :: UnitType -> Bool --Wrong
buildTime :: UnitType -> Int
maxEnergy :: UnitType -> Int
isWorker :: UnitType -> Bool
airRange :: UnitType -> Int
airDamage :: UnitType -> Int
groundMinRange :: UnitType -> Int
groundMaxRange :: UnitType -> Int
tileHeight :: UnitType -> Int
sightRange :: UnitType -> Int
canMove :: UnitType -> Bool
whatBuilds ::UnitType -> UnitType 
mineralsCost :: UnitType -> Int
gasCost :: UnitType -> Int
maxHitPoints :: UnitType -> Int
tileWidth :: UnitType -> Int
groundDamage :: UnitType -> Int
race :: UnitType -> Race
supplyProvided :: UnitType -> Int
...
isFlyer x = case x of
  ...
  TerranDropship -> True
  TerranValkyrie -> True
  TerranScienceVessel -> True
  TerranBattlecruiser -> True
  ZergScourge -> True
  ZergCocoon -> True
  ZergMutalisk -> True
  ZergGuardian -> True
  ...
  ZergQueen -> True
  ZergOverlord -> True
  ProtossInterceptor -> True
  ProtossObserver -> True
  ProtossCorsair -> True
  ProtossScout -> True
  ProtossShuttle -> True
  ProtossArbiter -> True
...
canAttackGround :: UnitType -> Bool
canAttackGround = (>0).groundDamage

canAttackAir :: UnitType -> Bool
canAttackAir = (>0) . airDamage

canAttack x = canAttackAir x || canAttackGround x
...
canMove TerranMarine = True
canMove TerranGhost = True
canMove TerranVulture = True
canMove TerranGoliath = True
canMove TerranSiegeTankTankMode =True
canMove TerranSCV = True
canMove TerranWraith = True
canMove TerranScienceVessel = True
canMove TerranDropship = True
canMove TerranBattlecruiser = True
canMove TerranVultureSpiderMine = False
canMove TerranNuclearMissile = False
canMove TerranSiegeTankSiegeMode = False
canMove TerranFirebat = True
canMove SpellScannerSweep = False
canMove TerranMedic = True
canMove ZergLarva = False
canMove ZergEgg = False
canMove ZergZergling = True
canMove ZergHydralisk = True
canMove ZergUltralisk = True
canMove ZergBroodling = False
canMove ZergDrone = True
canMove ZergOverlord = True
canMove ZergMutalisk = True
canMove ZergGuardian = True
canMove ZergQueen = True
canMove ZergDefiler = True
canMove ZergScourge = True
canMove ZergInfestedTerran = True
canMove TerranValkyrie = True
canMove ZergCocoon = False
canMove ProtossCorsair = True
canMove ProtossDarkTemplar = True
canMove ZergDevourer = False
canMove ProtossDarkArchon = True
canMove ProtossProbe = True
canMove ProtossZealot = True
canMove ProtossDragoon = True
canMove ProtossHighTemplar = True
canMove ProtossArchon = True
canMove ProtossShuttle = True
canMove ProtossScout = True
canMove ProtossArbiter = True
canMove ProtossCarrier = True
canMove ProtossInterceptor = True
canMove ProtossReaver = True
canMove ProtossObserver = True
canMove ProtossScarab = True
canMove CritterRhynadon = True
canMove CritterBengalaas = True
canMove CritterScantid = True
canMove CritterKakaru = True
canMove CritterRagnasaur = True
canMove CritterUrsadon = True
canMove ZergLurkerEgg = False
canMove ZergLurker = True
canMove SpellDisruptionWeb = False
canMove TerranCommandCenter = True
...
canMove TerranBarracks = True
canMove TerranAcademy = False
canMove TerranFactory = True
canMove TerranStarport = False
canMove TerranControlTower = False
canMove TerranScienceFacility = True
...
canMove SpecialOvermindWithShell = True
canMove SpecialOvermind = True
